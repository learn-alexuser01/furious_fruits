...
var game = {
    ...
    panTo: function (newCenter) {
        if (Math.abs(newCenter - game.offsetLeft - game.canvas.width / 3) > 0 &&
            game.offsetLeft <= game.maxOffset && game.offsetLeft >= game.minOffset) {
            var deltaX = Math.round((newCenter - game.offsetLeft - game.canvas.width /
                4) / 2);
    ...
    // needs rework to handle non circular shapes
    ...
    drawSlingshotBand:function(){
        ...
        game.context.moveTo(game.slingshotX+100-game.offsetLeft, game.slingshotY+25);
        ...
        game.context.lineTo(game.slingshotX-game.offsetLeft +20,game.slingshotY+25)
        game.context.stroke();
    },
...
var levels = {
    ...
    load: function (number) {
        ...
        game.currentLevel.backgroundImage = loader.loadImage("img/bg/" + level.background + ".png");
        game.currentLevel.foregroundImage = loader.loadImage("img/bg/" + level.foreground + ".png");
...
var entities = {
    ...
    //given and entity, it's position and the angle it should start, draw it on the game canvas
...
var box2d = {
    ...
    createRectangle: function (entity, definition) {
        ...
        fixtureDef.shape.SetAsBox(entity.width / 2 / box2d.scale, entity.height /
            2 / box2d.scale);
